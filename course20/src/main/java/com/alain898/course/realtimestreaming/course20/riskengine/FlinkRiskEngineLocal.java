...
public class FlinkRiskEngineLocal {
    ...
    public static class EventSplitFunction implements FlatMapFunction<JSONObject, JSONObject> {
        private static final Set<String> keys = FlinkRiskEngineLocal.keys;
    ...
    public static class FeatureEnrichFunction extends RichMapFunction<JSONObject, JSONObject> {
        private static final List<String[]> features = FlinkRiskEngineLocal.features;
        ...
        public JSONObject map(JSONObject value) throws Exception {
            ...
            for (String[] feature : features) {
                ...
                System.out.println("put features with name: " + featureName + " for keyvalue: " + value.getString("KEY_VALUE"));
            }
            return value;
        }
...
//            System.out.println("Checking object features: " + mergedValue.getJSONObject( "features" )  == null ? 0:mergedValue.getJSONObject( "features" ).size());
    ...
    public static class RuleBasedModeling implements MapFunction<JSONObject, JSONObject> {
        ...
        public JSONObject map(JSONObject value) throws Exception {
            ...
            System.out.println("Result: is abnormal: " + isAnomaly);
            return value;
        }
    }
